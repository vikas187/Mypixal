...
try{
    ...
    $query=mysqli_query_or_throw_error($con,("update picweekfp set likes=likes+1 where id=$id"));
    ...
    $query=mysqli_query_or_throw_error($con,("select `likes` from `picweekfp` where `id`='$id'"));
